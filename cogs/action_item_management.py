...
class ActionItemManager(commands.Cog):
    ...
    async def items_handbook_view(self,
        ...
        formatted_responses = await construct_item_display(items=[item], from_spellbook=True, guild=guild)
    ...
    async def items_inventory_view(self,
        ...
        formatted_responses = await construct_item_display(player=game_player, items=game_player.player_items, guild=guild)
    ...
    async def items_send_to_player(self,
        ...
        item_lost_formatted_responses = await construct_item_transfer_display(action='lost', item=item_to_send, guild=guild)
        item_gained_formatted_responses = await construct_item_transfer_display(action='gained', item=item_to_send, guild=guild)
    ...
    async def actions_available_view(self,
        ...
        formatted_responses = await construct_action_display(player=game_player, actions=game_player.player_actions, guild=guild)
