...
class Game:
    def __init__(self, is_active: bool, parties_locked: bool, voting_locked: bool, players: List[Player],
                 parties: List[Party], rounds: List[Round]):
...
# async def serialization_defaults(obj):
